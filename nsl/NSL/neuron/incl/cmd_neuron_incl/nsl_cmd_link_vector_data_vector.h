//
// 	nsl_cmd_link_vector_data_vector.h
//

#ifndef _NSL_CMD_LINK_VECTOR_DATA_VECTOR_H
#define _NSL_CMD_LINK_VECTOR_DATA_VECTOR_H
#include "nsl_cmd_link_vector_vector.h"
class nsl_cmd_link_vector_data_vector : public nsl_cmd_link_vector_vector
{
public:
		nsl_cmd_link_vector_data_vector();
		~nsl_cmd_link_vector_data_vector();

	int init_cmd_link_vector_data_vector();
	int set_cmd_link_vector_data_vector();
	...
	virtual int cmd_step(nsl_interpreter&);
		...
		int print_cmd_link_vector_data_vector(std::ostream&) const;
