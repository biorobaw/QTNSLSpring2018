//
// 	nsl_cmd_link_data_matrix_vector.h
//


#ifndef _NSL_CMD_LINK_DATA_MATRIX_VECTOR_H
#define _NSL_CMD_LINK_DATA_MATRIX_VECTOR_H
#include "nsl_cmd_link_data_vector.h"
class nsl_cmd_link_data_matrix_vector : public nsl_cmd_link_data_vector
{
public:
		nsl_cmd_link_data_matrix_vector();
		~nsl_cmd_link_data_matrix_vector();

	int init_cmd_link_data_matrix_vector();
	int set_cmd_link_data_matrix_vector();
	...
	virtual int cmd_step(nsl_interpreter&);
		...
		int print_cmd_link_data_matrix_vector(std::ostream&) const;
