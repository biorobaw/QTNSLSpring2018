//
// 	nsl_cmd_site_matrix.h
//

#ifndef _NSL_CMD_SITE_MATRIX_H
#define _NSL_CMD_SITE_MATRIX_H
#include "nsl_cmd_site_layer.h"
class nsl_cmd_site_matrix : public nsl_cmd_site_layer
{
public:
		nsl_cmd_site_matrix();
		~nsl_cmd_site_matrix();

	int init_cmd_site_matrix();
	int set_cmd_site_matrix();
	...
	virtual int cmd_step(nsl_interpreter&);
		...
		int print_cmd_site_matrix(std::ostream&) const;
