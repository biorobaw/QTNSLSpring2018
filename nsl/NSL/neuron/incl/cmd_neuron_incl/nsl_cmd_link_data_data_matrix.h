//
// 	nsl_cmd_link_data_data_matrix.h
//

#ifndef _NSL_CMD_LINK_DATA_DATA_MATRIX_H
#define _NSL_CMD_LINK_DATA_DATA_MATRIX_H
#include "nsl_cmd_link_data_matrix.h"
class nsl_cmd_link_data_data_matrix : public nsl_cmd_link_data_matrix
{
public:
		nsl_cmd_link_data_data_matrix();
		~nsl_cmd_link_data_data_matrix();

	int init_cmd_link_data_data_matrix();
	int set_cmd_link_data_data_matrix();
	...
	virtual int cmd_step(nsl_interpreter&);
		...
		int print_cmd_link_data_data_matrix(std::ostream&) const;
