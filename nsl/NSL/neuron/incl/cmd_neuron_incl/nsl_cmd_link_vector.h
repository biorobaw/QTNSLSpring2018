//
// 	nsl_cmd_link_vector.h
//

#ifndef _NSL_CMD_LINK_VECTOR_H
#define _NSL_CMD_LINK_VECTOR_H
#include "nsl_cmd_link_layer.h"


class nsl_cmd_link_vector : public nsl_cmd_link_layer
{
public:
		nsl_cmd_link_vector();
		~nsl_cmd_link_vector();

	int init_cmd_link_vector();
	int set_cmd_link_vector();
	...
	virtual int cmd_step(nsl_interpreter&);
		...
		int print_cmd_link_vector(std::ostream&) const;
