/* SCCS  @(#)nsl_vector_mult_library.C	1.1---95/08/13--20:48:22 */
//
//	nsl_vector_mult_library.C
//
#include "nsl.h"
#include "nsl_num_2.h"
#include "nsl_num_1.h"
...
nsl_num_1 NSLmult(const nsl_num_1& a,const nsl_num_1& b)
{
	int aimax = a.get_imax();
	int bimax = b.get_imax();
...
nsl_num_1 NSLmult(const nsl_num_1& a,const num_type b)
{
	int aimax = a.get_imax();
...
nsl_num_1 NSLmult(const num_type a, const nsl_num_1& b)
{
	int bimax = b.get_imax();
...
nsl_num_1 NSLmult(const nsl_num_1& a,const nsl_num_0& b)
{
	int aimax = a.get_imax();
...
nsl_num_1 NSLmult(const nsl_num_0& a,const  nsl_num_1& b)
{
	int bimax = b.get_imax();
