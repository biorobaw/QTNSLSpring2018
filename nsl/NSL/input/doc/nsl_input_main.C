...
// input layer
//	cmd_type = CMD_SHELL->get_type_cmd("layer");
//	cmd_type = new nsl_cmd_input_stim;

	cmd_type = new nsl_cmd_input_layer; 
	CMD_SHELL->add_type_i_children(cmd_type,"layer");
	CMD_SHELL->add_type_m_parent(cmd_type,"model");

	cmd_set = new nsl_cmd_set_int_data("xz",0);
 	cmd_type->add_data(cmd_set);
 	cmd_set = new nsl_cmd_set_int_data("yz",0);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_num_data("dx",1.0);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_num_data("dy",1.0);
 	cmd_type->add_data(cmd_set);
	//cmd_set = new nsl_cmd_set_on_off("overlap",NSL_ON);
 	//cmd_type->add_data(cmd_set);
...
// input stim
	...
	cmd_set = new nsl_cmd_set_str_data("name");
 	cmd_type->add_data(cmd_set);

	cmd_set = new nsl_cmd_set_int_data("index");
 	cmd_type->add_data(cmd_set);

	cmd_set = new nsl_cmd_set_num_data("val",1.0);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_int_data("step",1);
 	cmd_type->add_data(cmd_set);
	//cmd_set = new nsl_cmd_set_on_off("interval",NSL_ON); //TODO: fix, type speicifer before this
 	//cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_num_data("vx",0.0);
 	cmd_type->add_data(cmd_set);
 	cmd_set = new nsl_cmd_set_num_data("vy",0.0);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_num_data("x0",0.0);
 	cmd_type->add_data(cmd_set);
 	cmd_set = new nsl_cmd_set_num_data("y0",0.0);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_num_data("xc",0.0);
 	cmd_type->add_data(cmd_set);
 	cmd_set = new nsl_cmd_set_num_data("yc",0.0);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_num_data("dx",1.0);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_num_data("dy",1.0);
 	cmd_type->add_data(cmd_set);
	/*cmd_set = new nsl_cmd_stim_type("stim_type",NSL_BLOCK);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_spec_type("spec_type",NSL_CORNER);
 	cmd_type->add_data(cmd_set);
	...
	cmd_set = new nsl_cmd_set_num_data("icon",1.0);
 	cmd_type->add_data(cmd_set);
	...
	cmd_set = new nsl_cmd_set_num_vector("icon",1.0);
 	cmd_type->add_data(cmd_set);
	...
	cmd_set = new nsl_cmd_set_num_matrix("icon",1.0);
 	cmd_type->add_data(cmd_set);
	...
	cmd_set = new nsl_cmd_set_num_data("t0",0.0);
 	cmd_type->add_data(cmd_set);
	cmd_set = new nsl_cmd_set_num_data("t1",1.0);
 	cmd_type->add_data(cmd_set);
}
*/
//no such symbol defined nsl_mod_input_init -bn7
