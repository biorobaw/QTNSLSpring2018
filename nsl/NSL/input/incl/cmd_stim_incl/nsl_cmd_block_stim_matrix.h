/**************************************************************/
/*                                                            */
/*                   nsl_cmd_block_stim_matrix.h              */
/*                                                            */
/**************************************************************/

#ifndef _NSL_CMD_BLOCK_STIM_MATRIX_H
#define _NSL_CMD_BLOCK_STIM_MATRIX_H
#include "nsl_cmd_stim_matrix.h"
class nsl_cmd_block_stim_matrix : public nsl_cmd_stim_matrix
{
public:
		nsl_cmd_block_stim_matrix();
		~nsl_cmd_block_stim_matrix();
