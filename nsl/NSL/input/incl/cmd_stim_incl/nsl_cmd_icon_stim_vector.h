/**************************************************************/
/*                                                            */
/*                   nsl_cmd_icon_stim_vector.h               */
/*                                                            */
/**************************************************************/

#ifndef _NSL_CMD_ICON_STIM_VECTOR_H
#define _NSL_CMD_ICON_STIM_VECTOR_H
#include "nsl_cmd_stim_vector.h"
class nsl_cmd_icon_stim_vector : public nsl_cmd_stim_vector
{
public:
		nsl_cmd_icon_stim_vector();
		~nsl_cmd_icon_stim_vector();
