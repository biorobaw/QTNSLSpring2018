...
nsl_din_num_4<NslNumType>::nsl_din_num_4(const int s1,const int s2,
	const int s3,const int s4,int sfg,int fg,int rfg) : 
	nsl_num_4(s1,s2,s3,s4,sfg,fg,rfg)
{
//	_port = new AslInOutPort<NslDinFloat4>(str,m,this,ASL_DATA_INPUT);
}
template<class NslNumType>
nsl_din_num_4<NslNumType>::nsl_din_num_4(const char* str,nsl_public* m,const int s1,
...
template<class NslNumType>
nsl_din_num_4<NslNumType>::nsl_din_num_4(const nsl_din_num_4<NslNumType>& a,
...
template<class NslNumType>
nsl_din_num_4<NslNumType>::~nsl_din_num_4()
{
...
template<class NslNumType>
void nsl_din_num_4<NslNumType>::initialize(const char* str,nsl_public* m,const int s1,
	const int s2, const int s3,const int s4, int sfg, int fg,int rfg) 
{
...
template<class NslNumType>
nsl_num_4<NslNumType>& nsl_din_num_4<NslNumType>::operator=(
...
template<class NslNumType>
nsl_num_4<NslNumType>& nsl_din_num_4<NslNumType>::operator=(const NslNumType a)
{
	int timax = get_imax();  
...
template<class NslNumType>
void nsl_din_num_4<NslNumType>::send()
{
	*((AslInOutPort<NslDinFloat4>*) _port) << *this;
}

template<class NslNumType>
void nsl_din_num_4<NslNumType>::receive()
{
	*((AslInOutPort<NslDinFloat4>*) _port) >> *this;
}
*/