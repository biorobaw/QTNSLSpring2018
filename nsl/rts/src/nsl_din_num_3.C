...
nsl_din_num_3<NslNumType>::nsl_din_num_3(const int s1,const int s2,
	const int s3,int sfg,int fg,int rfg) : nsl_num_3(s1,s2,s3,sfg,fg,rfg)
{
//	_port = new AslInOutPort<NslDinFloat3>(str,m,this,ASL_DATA_INPUT);
}
template<class NslNumType>
nsl_din_num_3<NslNumType>::nsl_din_num_3(const char* str,nsl_public* m,const int s1,
...
template<class NslNumType>
nsl_din_num_3<NslNumType>::nsl_din_num_3(const nsl_din_num_3<NslNumType>& a,
...
template<class NslNumType>
nsl_din_num_3<NslNumType>::~nsl_din_num_3()
{
...
template<class NslNumType>
void nsl_din_num_3<NslNumType>::initialize(const char* str,nsl_public* m,const int s1,
	const int s2, const int s3,int sfg,int fg,int rfg)
{
...
template<class NslNumType>
nsl_num_3<NslNumType>& nsl_din_num_3<NslNumType>::operator=(
...
template<class NslNumType>
nsl_num_3<NslNumType>& nsl_din_num_3<NslNumType>::operator=(const NslNumType a)
{
       for (int i = 0; i < imax; i++)
           for (int j = 0; j < jmax; j++)
        	for (int k = 0; k < kmax; k++)
...
template<class NslNumType>
void nsl_din_num_3<NslNumType>::send()
{
	*((AslInOutPort<NslDinFloat3>*) _port) << *this;
}

template<class NslNumType>
void nsl_din_num_3<NslNumType>::receive()
{
	*((AslInOutPort<NslDinFloat3>*) _port) >> *this;
}
*/