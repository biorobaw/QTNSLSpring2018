...
class nsl_dout_num_4 : public nsl_num_4<NslNumType,NslTypeId>
{
public:
		nsl_dout_num_4(const int = 0,const int = 0,
			const int = 0,const int = 0,int=0,int=0,int=1);
		nsl_dout_num_4(const char*,nsl_public* = 0,const int = 0,
			const int = 0,const int = 0,const int = 0,
			int = 0,int=1,int=1);
		nsl_dout_num_4(const nsl_dout_num_4<NslNumType,NslTypeId>&,int = 0,int=0,int=1);
...
template<class NslNumType, int NslTypeId>
nsl_dout_num_4<NslNumType,NslTypeId>::nsl_dout_num_4(const int s1,const int s2,
...
template<class NslNumType, int NslTypeId>
nsl_dout_num_4<NslNumType,NslTypeId>::nsl_dout_num_4(const char* str,nsl_public* m,const int s1,
...
template<class NslNumType, int NslTypeId>
nsl_dout_num_4<NslNumType,NslTypeId>::nsl_dout_num_4(const nsl_dout_num_4<NslNumType,NslTypeId>& a,
...
template<class NslNumType, int NslTypeId>
nsl_dout_num_4<NslNumType,NslTypeId>::~nsl_dout_num_4()
{
...
template<class NslNumType, int NslTypeId>
void nsl_dout_num_4<NslNumType,NslTypeId>::initialize(const char* str,nsl_public* m,const int s1,
	const int s2, const int s3,const int s4, int sfg, int fg,int rfg)  
{
...
template<class NslNumType, int NslTypeId>
nsl_num_4<NslNumType,NslTypeId>& nsl_dout_num_4<NslNumType,NslTypeId>::operator=(const NslFloat4& a)
{
...
template<class NslNumType, int NslTypeId>
nsl_num_4<NslNumType,NslTypeId>& nsl_dout_num_4<NslNumType,NslTypeId>::operator=(const NslDouble4& a)
{
	if (a.get_imax() != imax || a.get_jmax() != jmax || 
		a.get_kmax() != kmax || a.get_lmax() != lmax)
	{
...
template<class NslNumType, int NslTypeId>
nsl_num_4<NslNumType,NslTypeId>& nsl_dout_num_4<NslNumType,NslTypeId>::operator=(const NslInt4& a)
{
	if (a.get_imax() != imax || a.get_jmax() != jmax || 
		a.get_kmax() != kmax || a.get_lmax() != lmax)
	{
...
/*
template<class NslNumType, int NslTypeId>
nsl_num_4<NslNumType,NslTypeId>& nsl_dout_num_4<NslNumType,NslTypeId>::operator=(
...
*//*
template<class NslNumType, int NslTypeId>
nsl_num_4<NslNumType,NslTypeId>& nsl_dout_num_4<NslNumType,NslTypeId>::operator=(const NslFloat0& a)
{
	int timax = get_imax();  
...
*//*
template<class NslNumType, int NslTypeId>
nsl_num_4<NslNumType,NslTypeId>& nsl_dout_num_4<NslNumType,NslTypeId>::operator=(const float a)
{
	int timax = get_imax();  
...
template<class NslNumType, int NslTypeId>
nsl_num_4<NslNumType,NslTypeId>& nsl_dout_num_4<NslNumType,NslTypeId>::operator=(const double a)
{
	int timax = get_imax();  
...
template<class NslNumType, int NslTypeId>
nsl_num_4<NslNumType,NslTypeId>& nsl_dout_num_4<NslNumType,NslTypeId>::operator=(const int a)
{
	int timax = get_imax();  
...
template<class NslNumType, int NslTypeId>
void nsl_dout_num_4<NslNumType,NslTypeId>::send()
{
	*((AslInOutPort<NslNumType>*) _port) << *this;
}
template<class NslNumType, int NslTypeId>
void nsl_dout_num_4<NslNumType,NslTypeId>::receive()
{
	*((AslInOutPort<NslNumType>*) _port) >> *this;
}
template<class NslNumType, int NslTypeId>
void nsl_dout_num_4<NslNumType,NslTypeId>::copy(nsl_layer* var)
{
	*this = *((nsl_num_4<NslNumType,NslTypeId>*) var);
} */
