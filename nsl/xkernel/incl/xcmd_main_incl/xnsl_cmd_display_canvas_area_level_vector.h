/* SCCS  %W%---%E%--%U% */
//
// 	xnsl_cmd_display_canvas_area_level_vector.h
//
#ifndef _XNSL_CMD_DISPLAY_CANVAS_AREA_LEVEL_VECTOR_H
#define _XNSL_CMD_DISPLAY_CANVAS_AREA_LEVEL_VECTOR_H
#include "xnsl_cmd_display_canvas_area_level.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_canvas_area_level_vector : 
	public xnsl_cmd_display_canvas_area_level
{
public:
	xnsl_cmd_display_canvas_area_level_vector();
	virtual~xnsl_cmd_display_canvas_area_level_vector();
