/* SCCS  %W%---%E%--%U% */
//
// 	xnsl_cmd_display_window_area_level_3.h
//

#ifndef _XNSL_CMD_DISPLAY_WINDOW_AREA_LEVEL_3_H
#define _XNSL_CMD_DISPLAY_WINDOW_AREA_LEVEL_3_H
#include "xnsl_cmd_display_window_area_level.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_window_area_level_3 : public 
	xnsl_cmd_display_window_area_level
{
public:
		xnsl_cmd_display_window_area_level_3();
		~xnsl_cmd_display_window_area_level_3();
