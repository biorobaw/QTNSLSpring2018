...
/**************************************************************/
/*                                                            */
/*           xnsl_cmd_display_canvas_area_level_4.C      */
/*                                                            */
/**************************************************************/
...
xnsl_cmd_display_canvas_area_level_4::
	xnsl_cmd_display_canvas_area_level_4()
{
        set_type("display_canvas_area_level_graph_4");
}
xnsl_cmd_display_canvas_area_level_4::
	~xnsl_cmd_display_canvas_area_level_4()
{
}
int xnsl_cmd_display_canvas_area_level_4::create_data(nsl_base* win,
...
int xnsl_cmd_display_canvas_area_level_4::update_data(nsl_base* win,
	int x,int y,int w,int h,
	int wx0,int wy0,int wx1,int wy1,int wxs,int wys)
{
...
int xnsl_cmd_display_canvas_area_level_4::create_graph(nsl_base* win,
	int x,int y,int w,int h,
...
//		    ((xnsl_area_level_graph_matrix*) cw)->set_i1(i);
               ...
               if ((data = (nsl_layer*) dlist->get_by_name("elem_j")) != NULL)
	       {
	            j = ((nsl_int_data*) data)->get_value();
//		    ((xnsl_area_level_graph_matrix*) cw)->set_j0(j);
//		    ((xnsl_area_level_graph_matrix*) cw)->set_j1(j);
  	       }
               else
                    cmd_error("cmd_display_canvas: NULL 'elem_j' obj");

	       int imax = ((nsl_4_layer*) layer)->get_imax();
	       int jmax = ((nsl_4_layer*) layer)->get_jmax();

	       if (i >= 0 && i < imax  && j >= 0 && j < jmax) 
	       {
	    	   NslFloat2& m = (*((NslFloat4*) layer))[i][j];

            	   cw = new xnsl_area_level_graph_matrix(
			(xnsl_display_canvas*) win,&m);
			...
			cw->set_wname(str);
	    	  ...
	    	  cmd_error("cmd_display_canvas_area_level_4: Cannot create graph");
	    }
	    else
	    	cmd_error("cmd_display_canvas_area_level_4: NULL graph list");
  	}
	else
	    cmd_error("cmd_display_canvas_area_level_4: Cannot create graph");
...
int xnsl_cmd_display_canvas_area_level_4::update_graph(nsl_base* win,
	int x,int y,int w,int h,
