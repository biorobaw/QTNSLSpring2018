...
/**************************************************************/
/*                                                            */
/*           xnsl_cmd_display_canvas_temporal_vector.C        */
/*                                                            */
/**************************************************************/
...
xnsl_cmd_display_canvas_temporal_vector::
	xnsl_cmd_display_canvas_temporal_vector()
{
        set_type("display_canvas_temporal_graph_vector");
}
xnsl_cmd_display_canvas_temporal_vector::
	~xnsl_cmd_display_canvas_temporal_vector()
{
}
int xnsl_cmd_display_canvas_temporal_vector::create_data(nsl_base* win,
...
int xnsl_cmd_display_canvas_temporal_vector::update_data(nsl_base* win,
	int x,int y,int w,int h,int wx0,int wy0,int wx1,int wy1,int wxs,int wys)
{
...
int xnsl_cmd_display_canvas_temporal_vector::create_graph(nsl_base* win,
	...
	const char*)
{
	...
	{
            cw = new xnsl_temporal_graph_vector((xnsl_display_canvas*) win,layer);
	    ...
	    cmd_error("cmd_display_canvas_temporal_vec: Cannot create graph");

 	return 1;
}
int xnsl_cmd_display_canvas_temporal_vector::update_graph(nsl_base* win,
	int x,int y,int w,int h,
	int wx0,int wy0,int wx1,int wy1,int wxs,int wys,nsl_layer *layer,
	const char*)
{
	    ...
	    (cw = (xnsl_graph*) list->get_by_name("graph")) != NULL)
	{
		    ...
		    ((xnsl_temporal_graph_vector*) cw)->set_i0(i);
  	    	}
            	else
	    	...
	    	{
	            i = ((nsl_int_data*) data)->get_value();
		    ((xnsl_temporal_graph_vector*) cw)->set_i1(i);
  	    	}
            	else
		...
		cmd_error("cmd_display_canvas_temporal_vector: NULL window");
