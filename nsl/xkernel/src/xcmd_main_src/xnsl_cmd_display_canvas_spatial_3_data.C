...
/**************************************************************/
/*                                                            */
/*           xnsl_cmd_display_canvas_spatial_3_data.C         */
/*                                                            */
/**************************************************************/
...
xnsl_cmd_display_canvas_spatial_3_data::
	xnsl_cmd_display_canvas_spatial_3_data()
{
        set_type("display_canvas_spatial_graph_3_data");
}
xnsl_cmd_display_canvas_spatial_3_data::
	~xnsl_cmd_display_canvas_spatial_3_data()
{
}
int xnsl_cmd_display_canvas_spatial_3_data::create_data(nsl_base* win,
...
int xnsl_cmd_display_canvas_spatial_3_data::update_data(nsl_base* win,
	int x,int y,int w,int h,int wx0,int wy0,int wx1,int wy1,int wxs,int wys)
{
...
int xnsl_cmd_display_canvas_spatial_3_data::create_graph(nsl_base* win,
	...
	const char*)
{
	...
	{
            cw = new xnsl_spatial_graph_3_data((xnsl_display_canvas*) win,layer);
	    ...
	    cmd_error("cmd_display_canvas_spatial_3_dat: Cannot create graph");

 	return 1;
}
int xnsl_cmd_display_canvas_spatial_3_data::update_graph(nsl_base* win,
	int x,int y,int w,int h,
	int wx0,int wy0,int wx1,int wy1,int wxs,int wys,nsl_layer *layer,
	const char*)
{
