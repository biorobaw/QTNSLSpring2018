...
/**************************************************************/
/*                                                            */
/*           xnsl_cmd_display_panel_spatial_3_vector.C        */
/*                                                            */
/**************************************************************/
...
xnsl_cmd_display_panel_spatial_3_vector::
	xnsl_cmd_display_panel_spatial_3_vector()
{
        set_type("display_panel_spatial_graph_3_vector");
}
xnsl_cmd_display_panel_spatial_3_vector::
	~xnsl_cmd_display_panel_spatial_3_vector()
{
}
int xnsl_cmd_display_panel_spatial_3_vector::create_data(nsl_base* win,
