...
xnsl_cmd_display_canvas_4::xnsl_cmd_display_canvas_4()
{
	set_type("display_canvas_4");
}
xnsl_cmd_display_canvas_4::~xnsl_cmd_display_canvas_4()
{
}
int xnsl_cmd_display_canvas_4::create_data(nsl_base* win,
...
int xnsl_cmd_display_canvas_4::update_data(nsl_base*,
	int,int,int,int,int,int,int,int,int,int)
{
	return 1;
} 
