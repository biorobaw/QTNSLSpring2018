/* SCCS  %W%---%E%--%U% */
//
// 	xnsl_cmd_display_window_area_level_data.h
//

#ifndef _XNSL_CMD_DISPLAY_WINDOW_AREA_LEVEL_DATA_H
#define _XNSL_CMD_DISPLAY_WINDOW_AREA_LEVEL_DATA_H
#include "xnsl_cmd_display_window_area_level.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_window_area_level_data : public 
