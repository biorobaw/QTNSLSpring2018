/* SCCS  %W%---%E%--%U% */
//
// 	xnsl_cmd_display_canvas_temporal.h
//
#ifndef _XNSL_CMD_DISPLAY_CANVAS_TEMPORAL_H
#define _XNSL_CMD_DISPLAY_CANVAS_TEMPORAL_H
#include "xnsl_cmd_display_canvas.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_canvas_temporal : public xnsl_cmd_display_canvas
{
public:
	xnsl_cmd_display_canvas_temporal();
	virtual ~xnsl_cmd_display_canvas_temporal();
