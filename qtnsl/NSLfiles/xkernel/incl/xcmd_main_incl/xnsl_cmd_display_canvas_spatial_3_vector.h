/* SCCS  %W%---%E%--%U% */
//
// 	xnsl_cmd_display_canvas_spatial_3_vector.h
//
#ifndef _XNSL_CMD_DISPLAY_CANVAS_SPATIAL_3_VECTOR_H
#define _XNSL_CMD_DISPLAY_CANVAS_SPATIAL_3_VECTOR_H
#include "xnsl_cmd_display_canvas_spatial_3.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_canvas_spatial_3_vector : 
	public xnsl_cmd_display_canvas_spatial_3
{
public:
	xnsl_cmd_display_canvas_spatial_3_vector();
	virtual~xnsl_cmd_display_canvas_spatial_3_vector();
