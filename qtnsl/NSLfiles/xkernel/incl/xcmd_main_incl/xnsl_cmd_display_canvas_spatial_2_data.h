/* SCCS  %W%---%E%--%U% */
//
// 	xnsl_cmd_display_canvas_spatial_2_data.h
//
#ifndef _XNSL_CMD_DISPLAY_CANVAS_SPATIAL_2_DATA_H
#define _XNSL_CMD_DISPLAY_CANVAS_SPATIAL_2_DATA_H
#include "xnsl_cmd_display_canvas_spatial_2.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_canvas_spatial_2_data : 
	public xnsl_cmd_display_canvas_spatial_2
{
public:
	xnsl_cmd_display_canvas_spatial_2_data();
	virtual ~xnsl_cmd_display_canvas_spatial_2_data();
