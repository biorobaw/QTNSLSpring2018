//
// 	xnsl_cmd_display_window_3.h
//

#ifndef _XNSL_CMD_DISPLAY_WINDOW_4_H
#define _XNSL_CMD_DISPLAY_WINDOW_4_H
#include "xnsl_cmd_display_window.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_window_3 : public xnsl_cmd_display_window
{
public:
		xnsl_cmd_display_window_3();
		~xnsl_cmd_display_window_3();
