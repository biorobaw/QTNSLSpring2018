/* SCCS  %W%---%E%--%U% */
//
// 	xnsl_cmd_display_window_spatial_2_matrix.h
//
#ifndef _XNSL_CMD_DISPLAY_WINDOW_SPATIAL_2_MATRIX_H
#define _XNSL_CMD_DISPLAY_WINDOW_SPATIAL_2_MATRIX_H
#include "xnsl_cmd_display_window_spatial_2.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_window_spatial_2_matrix : public 
