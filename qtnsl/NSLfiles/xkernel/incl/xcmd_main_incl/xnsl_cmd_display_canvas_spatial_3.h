/* SCCS  %W%---%E%--%U% */
//
// 	xnsl_cmd_display_canvas_spatial_3.h
//
#ifndef _XNSL_CMD_DISPLAY_CANVAS_SPATIAL_3_H
#define _XNSL_CMD_DISPLAY_CANVAS_SPATIAL_3_H
#include "xnsl_cmd_display_canvas.h"
class nsl_interpreter;
class nsl_base;
class xnsl_cmd_display_canvas_spatial_3 : public xnsl_cmd_display_canvas
{
public:
	xnsl_cmd_display_canvas_spatial_3();
	virtual ~xnsl_cmd_display_canvas_spatial_3();
