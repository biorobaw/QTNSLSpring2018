...
xnsl_cmd_display_window_3::xnsl_cmd_display_window_3()
{
        set_type("display_window_3");
}

xnsl_cmd_display_window_3::~xnsl_cmd_display_window_3()
{
}
int xnsl_cmd_display_window_3::cmd_create(nsl_interpreter&)
{
	return 1;
}
int xnsl_cmd_display_window_3::cmd_init(nsl_interpreter&)
{
	return 1;
}
int xnsl_cmd_display_window_3::cmd_reset(nsl_interpreter&)
{
	return 1;
}
int xnsl_cmd_display_window_3::cmd_update(nsl_interpreter&)
{
	return 1;
}
int xnsl_cmd_display_window_3::set_win_sector(xnsl_window* win,
	int,int,int,int,int,int)
{
	   ...
	   (list = cmd_obj->get_data_list()) != NULL)
	{
          if ((data = (nsl_layer*) list->get_by_name("layer")) != NULL)
	  {
		...
		cmd_error("cmd_display_window_3: Bad layer name: ",lname);
	  }
          else
                cmd_error("cmd_display_window_3: NULL 'layer' obj");
...
int xnsl_cmd_display_window_3::create_data(nsl_base* win,
	...
	if (win != NULL && (cmd_obj = (nsl_cmd_type*) 
		...
		->get_mi_by_type(get_base_type())) != NULL	
	   	&& (list = cmd_obj->get_data_list()) != NULL)
     	{
		  ...
		  if ((layer = (nsl_layer*) SYSTEM->get_hier_object(lname)) != NULL)
		  {
			imax = ((nsl_3_layer*) layer)->get_imax();
			i1 = ((nsl_3_layer*) layer)->get_i1();
			jmax = ((nsl_3_layer*) layer)->get_jmax();
			j1 = ((nsl_3_layer*) layer)->get_j1();
			kmax = ((nsl_3_layer*) layer)->get_kmax();
			k1 = ((nsl_3_layer*) layer)->get_k1();
		  }
	  	}
          	else
...
int xnsl_cmd_display_window_3::init_data(nsl_base* win)
{
        int ival;
        nsl_layer* data;
        nsl_base* bdat;
...
int xnsl_cmd_display_window_3::reset_data(nsl_base*)
{
        nsl_layer* data;
        nsl_list* list = 0;
	nsl_cmd_type* cmd_obj; 
...
int xnsl_cmd_display_window_3::update_data(nsl_base* win,
	int,int,int,int,int,int,int,int,int,int)
{
        int ival;
        nsl_layer* data;
