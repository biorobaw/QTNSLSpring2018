...
/**************************************************************/
/*                                                            */
/*           xnsl_cmd_display_panel_spatial_2_vector.C        */
/*                                                            */
/**************************************************************/
...
xnsl_cmd_display_panel_spatial_2_vector::
	xnsl_cmd_display_panel_spatial_2_vector()
{
        set_type("display_panel_spatial_graph_2_vector");
}
xnsl_cmd_display_panel_spatial_2_vector::
	~xnsl_cmd_display_panel_spatial_2_vector()
{
}
int xnsl_cmd_display_panel_spatial_2_vector::create_data(nsl_base* win,
