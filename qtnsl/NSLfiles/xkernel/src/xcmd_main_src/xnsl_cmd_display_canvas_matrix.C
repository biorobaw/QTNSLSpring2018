...
/**************************************************************/
/*                                                            */
/*              xnsl_cmd_display_canvas_matrix.C              */
/*                                                            */
/**************************************************************/
...
xnsl_cmd_display_canvas_matrix::xnsl_cmd_display_canvas_matrix()
{
	set_type("display_canvas_matrix");
}
xnsl_cmd_display_canvas_matrix::~xnsl_cmd_display_canvas_matrix()
{
}
int xnsl_cmd_display_canvas_matrix::create_data(nsl_base* win,
...
int xnsl_cmd_display_canvas_matrix::update_data(nsl_base*,
	int,int,int,int,int,int,int,int,int,int)
{
	return 1;
} 
