...
/**************************************************************/
/*                                                            */
/*           xnsl_cmd_display_canvas_spatial_2_matrix.C       */
/*                                                            */
/**************************************************************/
...
xnsl_cmd_display_canvas_spatial_2_matrix::
	xnsl_cmd_display_canvas_spatial_2_matrix()
{
        set_type("display_canvas_spatial_graph_2_matrix");
}
xnsl_cmd_display_canvas_spatial_2_matrix::
	~xnsl_cmd_display_canvas_spatial_2_matrix()
{
}
int xnsl_cmd_display_canvas_spatial_2_matrix::create_data(nsl_base* win,
...
int xnsl_cmd_display_canvas_spatial_2_matrix::update_data(nsl_base* win,
	int x,int y,int w,int h,int wx0,int wy0,int wx1,int wy1,int wxs,int wys)
{
...
int xnsl_cmd_display_canvas_spatial_2_matrix::create_graph(nsl_base* win,
	...
	const char*)
{
	...
	{
            cw = new xnsl_spatial_graph_2_matrix((xnsl_display_canvas*) win,layer);
	    ...
	    cmd_error("cmd_display_canvas_spatial_2_mat: Cannot create graph");

 	return 1;
}
int xnsl_cmd_display_canvas_spatial_2_matrix::update_graph(nsl_base* win,
	int x,int y,int w,int h,
	int wx0,int wy0,int wx1,int wy1,int wxs,int wys,nsl_layer *layer,
	const char*)
{
	    ...
	    (cw = (xnsl_graph*) list->get_by_name("graph")) != NULL)
	{
		    ...
		    ((xnsl_spatial_graph_2_matrix*) cw)->set_i0(i);
  	    	}
            	else
	    	...
	    	{
	            i = ((nsl_int_data*) data)->get_value();
		    ((xnsl_spatial_graph_2_matrix*) cw)->set_i1(i);
  	    	}
            	else
	    	...
	    	{
	            i = ((nsl_int_data*) data)->get_value();
		    ((xnsl_spatial_graph_2_matrix*) cw)->set_j0(i);
  	    	}
            	else
	    	...
	    	{
	            i = ((nsl_int_data*) data)->get_value();
		    ((xnsl_spatial_graph_2_matrix*) cw)->set_j1(i);
  	    	}
            	else
		...
		cmd_error("cmd_display_canvas_spatial_2_matrix: NULL window");
