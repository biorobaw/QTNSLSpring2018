...
/**************************************************************/
/*                                                            */
/*              xnsl_cmd_display_window_matrix.C              */
/*                                                            */
/**************************************************************/
...
xnsl_cmd_display_window_matrix::xnsl_cmd_display_window_matrix()
{
        set_type("display_window_matrix");
}

xnsl_cmd_display_window_matrix::~xnsl_cmd_display_window_matrix()
{
}
int xnsl_cmd_display_window_matrix::cmd_create(nsl_interpreter&)
{
	return 1;
}
int xnsl_cmd_display_window_matrix::cmd_init(nsl_interpreter&)
{
	return 1;
}
int xnsl_cmd_display_window_matrix::cmd_reset(nsl_interpreter&)
{
	return 1;
}
int xnsl_cmd_display_window_matrix::cmd_update(nsl_interpreter&)
{
	return 1;
}
int xnsl_cmd_display_window_matrix::set_win_sector(xnsl_window* win,
	int,int,int,int,int,int)
{
	   ...
	   (list = cmd_obj->get_data_list()) != NULL)
	{
          if ((data = (nsl_layer*) list->get_by_name("layer")) != NULL)
	  {
		...
		cmd_error("cmd_display_window_matrix: Bad layer name: ",lname);
	  }
          else
                cmd_error("cmd_display_window_matrix: NULL 'layer' obj");
		...
		if (jmax <= 0)
		{
			...
			((nsl_int_data*) bdat)->set_value(jmax);
           	    else
		...
		if (j0 >= jmax || j0 < 0)
		{
			...
			((nsl_int_data*) bdat)->set_value(j0);
           	    else
		...
		if (j1 >= jmax || j1 < j0 || j1 < 0)
		{
			...
			((nsl_int_data*) bdat)->set_value(j1);
           	    else
...
int xnsl_cmd_display_window_matrix::create_data(nsl_base* win,
		...
		->get_mi_by_type(get_base_type())) != NULL	
	   	&& (list = cmd_obj->get_data_list()) != NULL)
     	{
           	if ((data = (nsl_layer*) list->get_by_name("layer")) != NULL)
	  		{
				...
				if ((layer = (nsl_layer*) SYSTEM->get_hier_object(lname)) != NULL)
				{
					imax = ((nsl_matrix*) layer)->get_imax();
					i1 = ((nsl_matrix*) layer)->get_i1();
					jmax = ((nsl_matrix*) layer)->get_jmax();
					j1 = ((nsl_matrix*) layer)->get_j1();
				}
	  		}
          	else
...
int xnsl_cmd_display_window_matrix::init_data(nsl_base* win)
{
        int ival;
        nsl_layer* data = 0;
        nsl_base* bdat = 0;
...
int xnsl_cmd_display_window_matrix::reset_data(nsl_base*)
{
        nsl_layer* data;
        nsl_list* list = 0;
	nsl_cmd_type* cmd_obj; 
...
int xnsl_cmd_display_window_matrix::update_data(nsl_base* win,
	int,int,int,int,int,int,int,int,int,int)
{
        int ival;
        nsl_layer* data;
