...
class nsl_din_num_2 : public nsl_num_2<NslNumType,NslTypeId>
{
public:
		nsl_din_num_2(const int = 0,const int = 0,int=0,int=0,int=1);
		nsl_din_num_2(const char*,nsl_public* = 0,const int = 0,
			const int = 0,int=0,int=1,int=1);
		nsl_din_num_2(const nsl_din_num_2<NslNumType,NslTypeId>&,int=0,int=0,int=1);
...
template<class NslNumType, int NslTypeId>
nsl_din_num_2<NslNumType,NslTypeId>::nsl_din_num_2(const int s1,const int s2,
...
template<class NslNumType, int NslTypeId>
nsl_din_num_2<NslNumType,NslTypeId>::nsl_din_num_2(const char* str,nsl_public* m,const int s1,
...
template<class NslNumType, int NslTypeId>
nsl_din_num_2<NslNumType,NslTypeId>::nsl_din_num_2(const nsl_din_num_2<NslNumType,NslTypeId>& a,
...
template<class NslNumType, int NslTypeId>
nsl_din_num_2<NslNumType,NslTypeId>::~nsl_din_num_2()
{
}
...
template<class NslNumType, int NslTypeId>
void nsl_din_num_2<NslNumType,NslTypeId>::initialize(const char* str,nsl_public* m,const int s1,
	const int s2, int sfg, int fg,int rfg)
{
...
template<class NslNumType, int NslTypeId>
nsl_num_2<NslNumType,NslTypeId>& nsl_din_num_2<NslNumType,NslTypeId>::operator=(const NslFloat2& a)
{
...
/*
template<class NslNumType, int NslTypeId>
nsl_num_2<NslNumType,NslTypeId>& nsl_din_num_2<NslNumType,NslTypeId>::operator=(const 
...
*//*
template<class NslNumType, int NslTypeId>
nsl_num_2<NslNumType,NslTypeId>& nsl_din_num_2<NslNumType,NslTypeId>::operator=(const NslFloat0& a)
{
...
*//*
template<class NslNumType, int NslTypeId>
nsl_num_2<NslNumType,NslTypeId>& nsl_din_num_2<NslNumType,NslTypeId>::operator=(const float a)
{
	for (int i = 0; i < imax; i++)
	   for (int j = 0; j < jmax; j++)
		(*v[i])[j] = (NslNumType) a;
...
template<class NslNumType, int NslTypeId>
nsl_num_2<NslNumType,NslTypeId>& nsl_din_num_2<NslNumType,NslTypeId>::operator=(const double a)
{
	for (int i = 0; i < imax; i++)
	   for (int j = 0; j < jmax; j++)
		(*v[i])[j] = (NslNumType) a;
...
template<class NslNumType, int NslTypeId>
nsl_num_2<NslNumType,NslTypeId>& nsl_din_num_2<NslNumType,NslTypeId>::operator=(const int a)
{
	for (int i = 0; i < imax; i++)
	   for (int j = 0; j < jmax; j++)
		(*v[i])[j] = (NslNumType) a;
...
template<class NslNumType, int NslTypeId>
void nsl_din_num_2<NslNumType,NslTypeId>::send()
{
	*((AslInOutPort<NslNumType>*) _port) << *this;
}

template<class NslNumType, int NslTypeId>
void nsl_din_num_2<NslNumType,NslTypeId>::receive()
{
	*((AslInOutPort<NslNumType>*) _port) >> *this;
}
template<class NslNumType, int NslTypeId>
void nsl_din_num_2<NslNumType,NslTypeId>::copy(nsl_layer* var)
{
