/**************************************************************/
/*                                                            */
/*                   nsl_cmd_block_stim_data.h                */
/*                                                            */
/**************************************************************/

#ifndef _NSL_CMD_BLOCK_STIM_DATA_H
#define _NSL_CMD_BLOCK_STIM_DATA_H
#include "nsl_cmd_stim_data.h"
class nsl_cmd_block_stim_data : public nsl_cmd_stim_data
{
public:
		nsl_cmd_block_stim_data();
		~nsl_cmd_block_stim_data();
